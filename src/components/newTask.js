...
const NewTask = () => {
    ...
    return (
        <div>
            <button type="button" className="btn btn-primary" style={{marginLeft:"690px"}} onClick={() => setState(true)} >New task</button>
            <Modal isOpen={state} style={{marginTop:"150px"}}>
                <ModalHeader>
                    Create new task
                    <button type="button" className="close" data-dismiss="modal" aria-label="Close"  style={{marginLeft: "280px" }} onClick={() => setState(false)}>
